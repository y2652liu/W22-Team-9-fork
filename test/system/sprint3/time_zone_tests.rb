...
class TimeZoneTests
  setup do
    ...
    @andy = User.create(email: 'andy@gmail.com', name: 'Andy', lastname: 'Orwall', is_admin: false, password: 'testpassword2', password_confirmation: 'testpassword2')
    @andy.teams << @team
    
    @sarah = User.create(email: 'sarah@gmail.com', name: 'Sarah', lastname: 'Jenkins', is_admin: false, password: 'testpassword3', password_confirmation: 'testpassword3')
    @sarah.teams << @team
    
    @mike = User.create(email: 'mike@gmail.com', name: 'Mike', lastname: 'Dean', is_admin: false, password: 'testpassword4', password_confirmation: 'testpassword4')
    @mike.teams << @team2
  end
