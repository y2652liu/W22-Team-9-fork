...
class AddDeleteTeamsTest < ApplicationSystemTestCase
  setup do 
    ...
    @feedback = save_feedback(10, "This team is disorganized", @user, DateTime.civil_from_format(:local, 2021, 3, 1), @team1, 2, "progress_comments", 2,2,2,2,2,2,2,2,2)
    @feedback2 = save_feedback(5, "This team is disorganized", @user, DateTime.civil_from_format(:local, 2021, 3, 3), @team1, 2, "progress_comments", 2,2,2,2,2,2,2,2,2)
