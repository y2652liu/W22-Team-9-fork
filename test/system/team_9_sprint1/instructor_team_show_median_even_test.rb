...
#class InstructorTeamShowMedianEvenTest < ApplicationSystemTestCase
  ...
  #setup do
    ...
    #@feedback = save_feedback(2, "This team is disorganized", @user2, Time.zone.now.to_datetime - 30, @team, 2)
    #@feedback = save_feedback(8, "This team is disorganized", @user3, Time.zone.now.to_datetime - 30, @team, 2) 
    #@feedback = save_feedback(2, "This team is disorganized", @user3, Time.zone.now.to_datetime - 30, @team, 2) 
